    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {["Library Stool Chair-1",
          "Library Stool Chair-2",
          "Library Stool Chair-3",
          "Library Stool Chair-4"]
          .map((product, i) => (
            <div key={i} className="w-80">
              ...
              <div className="p-4">
                <div className="flex justify-between items-center">
                  ...
                  <button className="mt-2 bg-blue-500 text-white px-4 py-2 rounded flex items-center justify-center w-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              name: "Wooden Chair",
              count: "157 Products",
              image: "Image-10",  // Correct this image name if needed
            },
            {
              name: "Desk Chair",
              count: "154 Products",
              image: "Image-29", // Correct this image name if needed
            },
          ].map((category, index) => (
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {["Image-9", "Image-5", "Image-24", "Image-5"].map((chair, index) => (
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {["Image-5", "Image-4", "Image-16", "Image-9"].map((product, i) => (
            <div key={i} className="w-80">
              <div className="relative w-full h-[312px]">
                <Image
                  src={`/${product}.png`}
              ...
              <div className="p-4">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-medium text-gray-800">Library Stool Chair</h3>
                  <button className="mt-2 bg-blue-500 text-white px-4 py-2 rounded flex items-center justify-center w-full">
                  <i className="fas fa-shopping-cart mr-2"></i> Add to Cart
                  </button>
                </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {["Image-19", "Image-24", "Image-25", "Image-30"].map((product, i) => (
            <div key={i} className="w-80">
              <div className="relative w-full h-[312px]">
                <Image
                  src={`/${product}.png`}
